...
import (
	...
	db "github.com/suryansh74/simplebank/db"
	sqlc "github.com/suryansh74/simplebank/db/sqlc"
)
...
func (mr *MockStoreMockRecorder) ListEntrys(ctx, arg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
